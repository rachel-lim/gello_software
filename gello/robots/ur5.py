# copy of ur.py that uses urx instead of rtde
...
class URRobot(Robot):
    ...
    def __init__(self, robot_ip: str = "192.168.1.10", no_gripper: bool = False):
        ...
        if not no_gripper:
            ...
            # port_num = 63352
            port_num = 30002
            self.gripper.connect(hostname=robot_ip, port=port_num)
    ...
    def command_joint_state(self, joint_state: np.ndarray) -> None:
        ...
        t_start = time.time()
        # t_start = self.robot.initPeriod()  # TODO
        self.robot.servoj(
        ...
        # self.robot.waitPeriod(t_start) # TODO
        time.sleep(1.0 - (time.time() - t_start))
